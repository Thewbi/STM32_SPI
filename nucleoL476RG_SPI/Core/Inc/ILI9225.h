...
//    #define CMD_PIN		GPIO_PIN_0 // Command select
    ...
    #define	CSX_PORT	CS_GPIO_Port
    #define CSX_PIN		CS_Pin // Chip select
    #define RESX_PORT	RST_GPIO_Port
    #define RESX_PIN	RST_Pin // Reset pin
    #define	CMD_PORT	CMD_GPIO_Port
    #define CMD_PIN		CMD_Pin // Command select
